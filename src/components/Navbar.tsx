                            ...
                            return (
                                <Link
                                    ...
                                    ${isActive
                                            ...
                                            : 'text-brand-ink/80 dark:text-brand-white/70 hover:text-brand-ink dark:hover:text-brand-white hover:bg-brand-ink/5 dark:hover:bg-brand-white/5'
                                        }`}
                                >
                                    {link.label}
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`font-mono text-sm transition-colors 
                                    ${isActive
                                        ? 'text-brand-ink/90 dark:text-brand-accent'
                                        : 'text-brand-ink/30 dark:text-brand-accent/40 group-hover:text-brand-ink/90 dark:group-hover:text-brand-accent/80'}`
                                }>
                                    0{i + 1}
                                </span>
                            </Link>
