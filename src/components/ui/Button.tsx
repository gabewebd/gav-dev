...
const Button = forwardRef<HTMLAnchorElement | HTMLButtonElement, ButtonProps>(({
    ...
    const variants = {
        primary: "bg-brand-white text-brand-dark px-6 md:px-14 py-3.5 md:py-6 hover:opacity-85",
        secondary: "border border-brand-white/20 text-brand-white px-6 md:px-14 py-3.5 md:py-6 hover:bg-brand-white/5",
    };
