    ...
    >
        ...
        <section className="hero-section pt-28 md:pt-40 mb-20 sm:mb-32 md:mb-48 relative z-10 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-start gap-10 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full max-w-[240px] sm:max-w-[300px] md:max-w-[380px] lg:max-w-[420px] mx-auto lg:mx-0 shrink-0 flex flex-col items-start">
              ...
              <div className="mt-8 sm:mt-10 flex w-full gap-8 sm:gap-12 fade-in-element">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-brand-white/40">Years Learning</span>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-brand-white/40">Projects Built</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col relative z-10 w-full text-left">
              ...
              <div className="flex flex-col gap-4 sm:gap-6 text-sm md:text-lg text-brand-white/70 leading-relaxed font-medium max-w-3xl fade-in-element">
      ...
      <section className="relative py-16 sm:py-24 md:py-40 bg-transparent border-y border-brand-white/5 exhibition-section">
        <div className="bg-icon-parallax absolute top-1/2 right-[-15vw] sm:right-[-5vw] lg:right-10 -translate-y-1/2 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] lg:w-[500px] lg:h-[500px] bg-brand-white/[0.02] rounded-[3rem] sm:rounded-[4rem] lg:rounded-[5rem] rotate-12 flex items-center justify-center pointer-events-none z-0 will-change-transform">
          <FaGraduationCap className="w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] lg:w-[200px] lg:h-[200px] text-brand-white/[0.07]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10 flex flex-col lg:flex-row gap-10 sm:gap-16 lg:gap-32">
          ...
          <div className="hidden lg:flex lg:w-4/12 sticky top-40 h-[calc(100vh-15rem)] flex-col justify-center z-30 pointer-events-none">
            <div className="flex flex-col gap-6 relative pl-10 border-l border-brand-white/10">
              <div className="absolute left-10 -top-8 text-[10px] font-bold uppercase tracking-[0.3em] text-brand-white/20">Background</div>
          ...
          <div className="flex flex-col gap-32 md:gap-48">
            ...
            <div className="background-content-section w-full">
              ...
              <div className="relative ml-2 md:ml-4 education-container">
                <div ref={timelineLineRef2} className="absolute top-0 bottom-0 left-0 w-[2px] md:w-[3px] bg-brand-white/10" />
                  ...
                  {EDUCATION.map((edu, i) => (
                    <div key={i} className="education-card relative w-full pl-6 sm:pl-10 md:pl-20">
                      <div className="flex flex-col gap-2 md:gap-4 mb-6">
                        <span className="font-mono text-xs md:text-sm font-medium text-brand-white/30">{edu.period}</span>
                        <h3 className="font-mori font-bold text-3xl md:text-5xl tracking-tighter text-brand-white leading-[1]">{edu.degree}</h3>
                      ...
                      <ul className="flex flex-col gap-4 max-w-2xl">
                        {edu.points.map((point, j) => (
                          <li key={j} className="flex items-start gap-4 text-sm md:text-base text-brand-white/60 font-medium">
            ...
            <div className="background-content-section w-full">
              ...
              <div className="relative ml-2 md:ml-4 pb-8 md:pb-12 history-container">
                <div className="absolute top-0 bottom-0 left-0 w-[2px] md:w-[3px] bg-brand-white/10" />
                ...
                <div className="relative w-full space-y-24 md:space-y-32 pt-12">
                  {EXPERIENCE.map((exp, i) => (
                    <div key={i} className="education-card relative w-full pl-6 sm:pl-10 md:pl-20">
                      <div className="flex flex-col gap-2 md:gap-4 mb-6">
                        <span className="font-mono text-xs md:text-sm font-medium text-brand-white/30">{exp.period}</span>
                        <h3 className="font-mori font-bold text-3xl md:text-5xl tracking-tighter text-brand-white leading-[1]">{exp.role}</h3>
                        <div className="flex items-center gap-3 text-sm md:text-base font-medium text-brand-white/40">
                          <span className="w-5 h-[1px] bg-brand-white/20" />
      ...
      <section className="relative py-20 sm:py-24 md:py-32 border-b border-brand-ink/5 dark:border-brand-white/5 bg-transparent">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
          ...
          <div className="mb-10 sm:mb-14 md:mb-16 flex flex-col md:flex-row md:items-end gap-3 md:gap-16">
            ...
            <p className="text-sm md:text-base text-brand-white/70 font-medium max-w-xs pb-1">
              Primary frameworks and systems used in my development cycles.
            </p>
          </div>

          <div className="filter-row flex items-end border-b border-brand-white/10 mb-10 sm:mb-12 gap-0 overflow-x-auto hide-scrollbar">
              ...
              return (
                <button
                  ...
                  className={`filter-tab group relative flex flex-col items-start gap-1.5 px-6 sm:px-8 pb-4 md:pb-5 pt-3 font-mori font-semibold uppercase tracking-[0.1em] text-sm md:text-base whitespace-nowrap transition-all duration-300 cursor-pointer border-b-2 -mb-[2px] ${isActive
                    ...
                    : "border-transparent text-brand-white/30 hover:text-brand-white/55"
                    }`}
                >
                  <span className={`text-[10px] font-black tabular-nums transition-colors duration-300 ${isActive
                    ? "text-brand-accent"
                    : "text-brand-white/20 group-hover:text-brand-white/55"
                    }`}>
      ...
      <section className="relative py-24 md:py-40 bg-transparent border-b border-brand-ink/5 dark:border-brand-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
          <div className="mb-12 md:mb-20 flex flex-col items-center text-center">
            ...
            <p className="mt-6 text-base md:text-lg text-brand-white/50 font-medium max-w-xl">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="text-sm md:text-base text-brand-white/50 font-medium leading-relaxed transition-colors duration-300">
                      {skill.description}
                    </p>
                  </div>
                </li>
            ...
            <div className="mt-8 sm:mt-12 h-[180px] sm:h-[140px] w-full max-w-2xl flex items-start justify-center">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-sm sm:text-base text-brand-white/60 font-medium leading-relaxed">
      ...
      <section className="relative py-24 sm:py-32 md:py-48 border-b border-brand-ink/5 dark:border-brand-white/5 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10 flex flex-col lg:flex-row gap-10 sm:gap-16 lg:gap-32">
          ...
          <div className="w-full lg:w-4/12 lg:sticky lg:top-40 h-fit">
            ...
            <p className="text-sm md:text-base lg:text-lg text-brand-white/50 font-medium leading-relaxed max-w-xs">
              ...
              <div className="relative w-full space-y-32 md:space-y-48 pt-12">
                {GOALS.map((goal, i) => (
                  <div key={i} className="group relative w-full pl-6 sm:pl-10 md:pl-20">
                    <span className="absolute left-8 sm:left-12 -top-6 sm:-top-10 text-[4rem] sm:text-[6rem] md:text-[8rem] font-mori font-black text-brand-white/[0.02] select-none pointer-events-none group-hover:text-brand-accent/10 transition-colors duration-700 leading-none">
                      {goal.num}
                    </span>
                    <div className="relative z-10 w-full">
                      <div className="flex items-center gap-6 mb-8">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-[1.25rem] border border-brand-white/10 flex items-center justify-center bg-white/[0.02] backdrop-blur-sm group-hover:border-brand-accent group-hover:bg-brand-accent transition-all duration-500 shrink-0">
                          <goal.icon className="w-6 h-6 md:w-8 md:h-8 text-brand-white/30 group-hover:text-brand-dark transition-colors duration-500" strokeWidth={1.5} />
                        </div>
                        <h3 className="font-mori font-bold text-3xl sm:text-5xl md:text-7xl tracking-tighter text-brand-white leading-[0.95]">
                          {goal.title}
                        </h3>
                      </div>
                      <div className="w-full h-[1px] bg-brand-white/10 mb-10 group-hover:bg-brand-accent transition-all duration-700" />
                      <p className="text-sm md:text-lg lg:text-xl text-brand-white/50 font-medium leading-relaxed max-w-xl group-hover:text-brand-white/70 transition-colors">
                        {goal.desc}
                      </p>
                    </div>
                  </div>
      ...
      <section className="relative py-20 sm:py-24 md:py-40 border-t border-brand-ink/5 dark:border-brand-white/5 bg-transparent">
        <div className="bg-icon-parallax absolute top-1/2 right-[-15vw] sm:right-[-5vw] lg:right-10 -translate-y-1/2 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] lg:w-[500px] lg:h-[500px] bg-brand-white/[0.02] rounded-[3rem] sm:rounded-[4rem] lg:rounded-[5rem] rotate-12 flex items-center justify-center pointer-events-none z-0 will-change-transform">
          <FaFileAlt className="w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] lg:w-[200px] lg:h-[200px] text-brand-white/[0.07]" />
        </div>
            ...
            {CERTIFICATIONS.map((group, gi) => (
              <div key={gi} className="py-6 sm:py-8 md:py-10 border-b border-brand-ink/10 dark:border-brand-white/10">
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap mb-4 sm:mb-5">
                  <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] px-2.5 py-1 rounded-full border border-brand-accent bg-brand-accent text-brand-dark transition-colors duration-300">
                    {group.issuer}
                  </span>
                  <span className="text-[10px] font-medium text-brand-white/30">{group.year}</span>
                </div>
